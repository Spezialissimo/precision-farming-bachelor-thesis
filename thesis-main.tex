...
% Divisione più sensata:

% Acquisizione dati:
% - Rilevazioni in laboratorio (in breve)
% - Sensori on-site
% - Remote sensing (in brevissimo)
% Simulazione dati: CSM (prima dei DSS in quanto i DSS includono qualche CSM spesso)
