\documentclass[12pt,a4paper,openright,twoside, openany, draft]{book}
\usepackage{acronym}
...
% \newpage
% %--------------------------------------------------------------------------------------------------
% \chapter{Tecnologie utilizzate}\label{capitolo-2}
...
\section{Analisi}
    ...
    %(Spiegazione delle necessità del progetto e i vincoli)
